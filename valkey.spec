...
Source0  : https://github.com/valkey-io/valkey/archive/8.0.0/valkey-8.0.0.tar.gz
Summary  : Minimalistic C client library for Redis.
Group    : Development/Tools
License  : BSD-2-Clause BSL-1.0 CC0-1.0 MIT
...
%prep
%setup -q -n valkey-8.0.0
cd %{_builddir}/valkey-8.0.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726522894
