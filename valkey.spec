...
Source0  : https://github.com/valkey-io/valkey/archive/refs/tags/7.2.6.tar.gz
...
%prep
%setup -q -n valkey-7.2.6
cd %{_builddir}/valkey-7.2.6
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722563303
...
cp %{_builddir}/valkey-%{version}/COPYING %{buildroot}/usr/share/package-licenses/valkey/44e5add5829f86c049fd08dffce57f00da52fd1f || :
...
cp %{_builddir}/valkey-%{version}/deps/hiredis/COPYING %{buildroot}/usr/share/package-licenses/valkey/e9c1298de98016808910005a33de3a5f25dce05e || :
...
/usr/share/package-licenses/valkey/44e5add5829f86c049fd08dffce57f00da52fd1f
...
/usr/share/package-licenses/valkey/e9c1298de98016808910005a33de3a5f25dce05e
